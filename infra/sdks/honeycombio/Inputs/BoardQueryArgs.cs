...
namespace Pulumi.Honeycombio.Inputs
{
    ...
    public sealed class BoardQueryArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("graphSettings")]
        private InputList<Inputs.BoardQueryGraphSettingArgs>? _graphSettings;
        ...
        /// </summary>
        public InputList<Inputs.BoardQueryGraphSettingArgs> GraphSettings
        {
            get => _graphSettings ?? (_graphSettings = new InputList<Inputs.BoardQueryGraphSettingArgs>());
        ...
        public BoardQueryArgs()
        {
        }
        public static new BoardQueryArgs Empty => new BoardQueryArgs();
    }
}

...
namespace Pulumi.Honeycombio
{
    static class Utilities
    {
        ...
        public static global::Pulumi.RegisterPackageRequest PackageParameterization()
        {
            return new global::Pulumi.RegisterPackageRequest(
                ...
                parameterization: new global::Pulumi.RegisterPackageRequest.PackageParameterization(
                    name: "honeycombio",
                    version: "0.36.1",
                    value: global::System.Convert.FromBase64String("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2hvbmV5Y29tYmlvL2hvbmV5Y29tYmlvIiwidmVyc2lvbiI6IjAuMzYuMSJ9fQ==")));
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Honeycombio.version.txt");
    ...
    internal sealed class HoneycombioResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public HoneycombioResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
